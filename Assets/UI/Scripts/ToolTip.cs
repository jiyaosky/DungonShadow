...
public class ToolTip : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        //Set UI Position
        dialog_box.transform.position = new Vector3(this.gameObject.transform.position.x + 70, this.gameObject.transform.position.y + 60, this.gameObject.transform.position.z);
